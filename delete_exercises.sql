...
SELECT album_name, release_date AS 'Albums release after 1991'
...
SELECT artist_name AS 'Albums by Whitney Houston', album_name
    FROM albums
    WHERE artist_name = 'Whitney Houston';
    DELETE FROM albums WHERE artist_name = 'Whitney Houston';

SELECT artist_name, release_date, genre
    FROM albums;