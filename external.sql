...
INSERT INTO albums(artists_name, album_name,release_date, sales, genre)
VALUES ('Michael Jackson', 'Thriller', 1982, 'Pop, post-disco, funk, rock', 51.2),
       ('AC/DC', 'Back in Black', 1980, 'Hard rock', 30.1),
       ('Whitney Houston', 'The Bodyguard', 1992, 'R&B, soul, pop, soundtrack', 28.7), ('Pink Floyd', 'The Dark Side of the Moon', 1973, 'Progressive rock', 24.8), ('Eagles', 'Their Greatest Hits (1971–1975)', 1976, 'Country rock, soft rock, folk rock', 41.2),
       ...
       ('Michael Jackson', 'Bad', 1987, 'Pop, rhythm and blues, funk and rock', 21.1), ('Meat Loaf', 'Bat Out of Hell', 1977, 'Hard rock, glam rock, progressive rock', 22),
       ('Alanis Morissette', 'Jagged Little Pill', 1995, 'Alternative rock', 25.4), ('Celine Dion', 'Falling into You', 1996, 'Pop, soft rock', 21.1),
       ...
       ('Guns N'' Roses', 'Appetite for Destruction', 1987, 'Hard rock', 22.8), ('Bruce Springsteen', 'Born in the U.S.A.', 1984, 'Heartland rock', 22), ('ABBA', 'Gold: Greatest Hits', 1992, 'Pop, disco', 21.6),
       ...
       ('Michael Jackson', 'Dangerous', 1991, 'New jack swing, R&B and pop', 17.0), ('The Beatles', 'Abbey Road', 1969, 'Rock', 16.9);
        --VALUES ("Michael", "Jackson", "Thiller", 1982, 51.2, "pop, post-disco, funk rock")
